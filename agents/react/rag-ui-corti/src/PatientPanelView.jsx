import { Loader2, LogOut, MessageSquare, Upload } from "lucide-react";
...
export default function PatientPanelView({
  clinician,
  onStartChat,
  starting,
  startError,
              ...
              {patients.map((patient) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground truncate" style={MONO}>
                      {patient.mrn}
                    </p>
                  </div>
                </li>
