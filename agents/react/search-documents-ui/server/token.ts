...
export interface ScopeClaims {
  sub: string;
  scopes: string[];
  // Display names per scope, e.g. { "patient:000-MOCK-5678": "John B. Placeholder" }.
...
export function signScopeToken(claims: ScopeClaims, ttlSeconds = 300, nowSeconds?: number): string {
