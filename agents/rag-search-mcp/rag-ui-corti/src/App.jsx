...
export default function App() {
  ...
  function disconnect() {
    setAuthed(false); setAgent(null); setClinician(null); setChatting(false)
  }
  // Clinician sign-out: keep Corti + agent, return to the clinician picker.
  function signOut() {
    setClinician(null); setChatting(false); setUploading(false)
  }
  ...
  if (!authed) {
    ...
    view = <AgentChatView agent={agent} clinician={clinician} initialContextId={chatContextId} onBack={() => setChatting(false)} />
  } else {
    view = (
      <PatientPanelView
        clinician={clinician}
