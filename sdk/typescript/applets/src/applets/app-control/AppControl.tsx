    ...
    <div ref={containerRef} className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Drive the application by voice — switch tabs, open the details panel,
          create an order and confirm it, or save. Dictate into the Notes tab as
          well; commands and dictation share one mic.
        </p>
      </div>
        ...
        <div className="rounded-md border border-border bg-muted/40 p-3">
          ...
          <ul className="space-y-1 text-xs text-muted-foreground">
            ...
            <li>
              ...
              / <span className="font-medium text-foreground">“save note”</span>{" "}
              — action buttons.
            </li>
            <li>
              <span className="font-medium text-foreground">
