...
type PkceCredentialsFormProps = {
  form: PkceFormState;
  setForm: React.Dispatch<React.SetStateAction<PkceFormState>>;
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900">
        ...
        &quot;Auth Code (with PKCE)&quot; there to create this kind of account.
        In the{" "}
        <a
          href={CONSOLE_URL}
          target="_blank"
        ...
        &quot;customers&quot; tab, add a client. No client secret is needed for
        PKCE.
      </div>
