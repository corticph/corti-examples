...
| ------------------ | ------------------ | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| SDK                | TypeScript         | [next](sdk/typescript/next/)                                                     | Next.js app with SDK examples (documents, facts, interactions, stream, etc.) and API route examples. |
